...
<body>
    <div class="container">
        <!-- Navbar Start --  -->
        <nav class="navbar navbar-expand-lg bg-info fw-bold">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 mt-3">
            <div class="col">
                <div class="card">
                    <img src="./../products img/rings/01.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to
                            additional content. This content is a little bit longer.</p>
                    </div>
                    <button id="btn" type="button" class="btn btn-info"><a href="./Catagories/Rings.php">Add to
                            cart</a></button>
                </div>
            ...
            <div class="col">
                <div class="card">
                    <img src="./../products img/ear rings img/02.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to
                            additional content. This content is a little bit longer.</p>
            ...
            <div class="col">
                <div class="card">
                    <img src="./../products img/ear rings img/03.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to
                            additional content. This content is a little bit longer</p>
            ...
            <div class="col">
                <div class="card">
                    <img src="./../products img/ear rings img/04.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to
                            additional content. This content is a little bit longer.</p>
